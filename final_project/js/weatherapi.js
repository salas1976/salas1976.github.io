const apiURL =
"//api.openweathermap.org/data/2.5/weather?q=orem&appid=5b5b8cf167465b793d3a51e879f4f818&units=imperial";
fetch(apiURL)
...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?q=orem&units=imperial&appid=da1b0232d1ee4f20081bffe175020995&units=imperial';
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastObject) => {
